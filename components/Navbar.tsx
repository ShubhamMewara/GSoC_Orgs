...
import { Technologies, Topics } from '@/packages/constants/filter'
...
const Navbar = () => {
  ...
  const { setSearch, selectedYear, setSelectedYear ,selectedTech ,setSelectedTech,selectedTopic, setSelectedTopic, numofOrgs  } = useGlobalContext()
  ...
  return (
    <div className='grid grid-cols-7 justify-evenly items-center h-20 sticky top-0 z-50 w-screen bg-gray-100 dark:bg-gray-800 supports-[backdrop-filter]:bg-gray-100/60 backdrop-blur'>
      <div className='grid grid-cols-4 justify-stretch col-span-6'>
