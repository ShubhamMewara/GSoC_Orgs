...
export async function scrapeProjects(year:number){
    ...
    try{
        ...
        await page.goto(`https://summerofcode.withgoogle.com/programs/2024/projects`, { timeout: 2 * 60 * 1000 });
        ...
        for (let i = 0; i <= numofpages; i++) {
            ...
            const next = await page.waitForSelector('body > app-root > app-layout > mat-sidenav-container > mat-sidenav-content.mat-drawer-content.mat-sidenav-content.site__main.theme.theme--gray.ng-star-inserted > div > div > main > app-program-projects > section > div > app-hybrid-projects-list > div:nth-child(2) > mat-paginator > div > div > div.mat-paginator-range-actions > button.mat-focus-indicator.mat-tooltip-trigger.mat-paginator-navigation-next.mat-icon-button.mat-button-base > span.mat-button-wrapper > svg');
            if(next){
            await next.click();
            }else{
